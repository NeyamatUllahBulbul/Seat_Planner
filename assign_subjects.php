        ...
        <div class="col-sm-4">
            <div class="page-header float-left">
                <div class="page-title">
                    <h1>Assign Subject to Batches</h1>
                </div>
            </div>
        </div>
        <div class="col-sm-8">
            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="assign_subjects_action.php" method="POST" class="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                            <div class="input-group-addon"><b>Select Subjects</b></div>
                                <?php 
                                    foreach($subjects AS $subject){      
                                ?>
                                <div class="col-md-6" style="display:block;">
                                    <input type="checkbox" id="subjects" value="<?=$subject['id']?>" name="subjects[]">

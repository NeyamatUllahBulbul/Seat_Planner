...
<body>
    <div class="row">
        ...
        <div class="col-2" style="margin-top: 22px;">
            <button style="background-color: #23B0ED;border: 1px solid #fff;border-radius:10px; height: 44px;width: 185px; color: white;" ><b>Online Admission</b></button>
        </div>
        <div class="col-3">
            <div class="pull-left">
...
?>
    ...
    <div class="row">
        <div class="col-4"></div>
        <div class="col-4">
                <form class="search" action="search_result_routine.php" name="search" method="GET">
